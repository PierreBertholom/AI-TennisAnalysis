...
def main():
    ...
    court_model_path = "models/keypoints_july.pth"
    ...
    for ball_shot_ind in range(len(ball_shot_frames) - 1):
        ...
        distance_covered_by_ball_meters = convert_pixel_to_distance_to_meters(distance_covered_by_ball_pixels,
        ...
        distance_covered_by_opponent_meters = convert_pixel_to_distance_to_meters(distance_covered_by_opponent_pixels,
                                                                                  constants.DOUBLE_LINE_WIDTH,
                                                                                  mini_court.get_width_of_mini_court())
